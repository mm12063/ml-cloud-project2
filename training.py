...
DJIA_SYMBOLS = ['AXP', 'AMGN', 'AAPL', 'BA', 'CAT', 'CSCO', 'CVX', 'GS', 'HD', 'HON', 'IBM', 'INTC', 'JNJ', 'KO', 'JPM', 'MCD', 'MMM', 'MRK', 'MSFT', 'NKE', 'PG', 'TRV', 'UNH', 'CRM', 'VZ', 'V', 'WBA', 'WMT', 'DIS']

# DJIA_SYMBOLS = ['AXP', 'AMGN']
...
model_save_dir = '/content/drive/My Drive/Model/'
...
for i, symb in enumerate(DJIA_SYMBOLS):
  df_ibm=pd.read_csv(f"/content/drive/My Drive/Stocks/csv_{NUM_YRS}yrs/{symb}.csv", parse_dates=True, index_col=0)
